(function() {
    ...
    let createEnablingMenu = () => {
        ...
        createEnableElement(speedButton, speedText, "speed", "Speed", 290, 95);
		  ...
		  speed1Button = document.createElement("button");
        speed1Text = document.createElement("div")
        createEnableElement(speed1Button, speed1Text, "speed1", "Speed1", 290, 95);
        ...
        bg.appendChild(speedButton);
		  ...
		  bg.appendChild(speed1Text);
        bg.appendChild(speed1Button);
    ...
    let guiMod = {
        init() {
            ...
            for (const key of Object.keys(guiPreSettings)){
                console.log(key);
                if(!Object.keys(guiSettings).includes(key)) {
                    guiSettings[key] = guiPreSettings[key];
                    localStorage.setItem('guiSettings', JSON.stringify(guiSettings));
                }
            }
            ...
            notify("Gui Mod Loaded", "by Awesomeguy <br> Modified by R3XFadeaway", "https://cdn.iconscout.com/icon/free/png-256/keyboard-arrow-4712861-3906731.png");
            ...
            try {
                ...
                if(isInLevel() && runtime.running_layout.name !== "Level Menu") {
                    ...
                    if(document.getElementById("speed") !== null) {
                        document.getElementById("speed").innerHTML =  Math.round(Math.sqrt(Math.pow(player.behavior_insts[0].dx, 2)));
                    }
						  if(document.getElementById("speed1") !== null) {
                        document.getElementById("speed1").innerHTML =  Math.round(Math.sqrt(Math.pow(player.behavior_insts[0].dy, 2)));
                    }
