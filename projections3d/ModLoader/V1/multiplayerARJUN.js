      ...
      (function () {
        ...
        let multiplayer = {
          ...
          getRoomCode() {
            ...
            //   console.log("returning roomcode");
            //   return roomCode;
            // } else {
            //   console.log("returning BASE64roomcode");
          ...
          updateChatBox() {
            ...
            if (this.chat && this.chat.length > 0) {
              ...
              chatBox.innerHTML = "No chat messages yet..." + "<br/>" + "Press 't' to chat!";
            }
            //scroll to bottom
            chatBox.scrollTop = chatBox.scrollHeight;
          },
          ...
          createRoom() {
            ...
            //   debug: 3,
            // });
            this.peer = new Peer([((Math.random() * 0xfffff * 1000000).toString(16)).slice(0, 6)]);
